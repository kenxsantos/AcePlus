...
class _Card4State extends State<Card4> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(Card4 oldWidget) {
    super.didUpdateWidget(oldWidget);

    print(
      "Card4 Updated! Old Expanded: ${oldWidget.isExpanded}, New: ${widget.isExpanded}",
    );
    print(
      "Card4 Updated! Old Flipped: ${oldWidget.isFlipped}, New: ${widget.isFlipped}",
    );
  ...
  void _updateAnimations() {
    positionAnimation = _createPositionAnimation(4);
  }
