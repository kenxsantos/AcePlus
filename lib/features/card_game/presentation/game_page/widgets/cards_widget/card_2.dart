...
class _Card2State extends State<Card2> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(Card2 oldWidget) {
    super.didUpdateWidget(oldWidget);

    print(
      "Card2 Updated! Old Expanded: ${oldWidget.isExpanded}, New: ${widget.isExpanded}",
    );
    print(
      "Card2 Updated! Old Flipped: ${oldWidget.isFlipped}, New: ${widget.isFlipped}",
    );
  ...
  void _updateAnimations() {
    positionAnimation = _createPositionAnimation(2);
  }
