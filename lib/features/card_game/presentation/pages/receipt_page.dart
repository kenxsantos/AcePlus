import 'package:aceplus/features/card_game/presentation/widgets/wallet_page_widgets/receipt_info.dart';
                        ...
                        ReceiptInfo(
                          ...
                          txtValue: TextSpan(
                            children: [
                              ...
                              TextSpan(
                                text:
                                    ' ${NumberFormat('#,##0.00').format(double.parse(transaction.amount.toString()))}',
                                style: TextStyle(
                                  fontFamily: lemon,
                                  color:
                                      transaction.transactionType == "Cash In"
